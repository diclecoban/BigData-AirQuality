...
\title{\textbf{A Distributed Streaming and Machine Learning Pipeline}\\
for Real-Time Air Quality Forecasting in Istanbul\\[0.5em]
\large Big Data Analytics Final Project}

\author{Ahmet Can Hatipoğlu \and Dicle Çoban \and Funda Çelik}
\date{June 2026}
...
Project & Real-Time Air Quality Monitoring and Prediction for Istanbul \\
Report Type & Final Report \\
Team Members & Ahmet Can Hatipoğlu, Dicle Çoban, Funda Çelik \\
Core Technologies & Apache Kafka, Apache Spark, Spark MLlib, MLflow, TimescaleDB, Grafana, Docker \\
Evaluation Dataset & 263,520 synthetic hourly air-quality records from 30 Istanbul stations \\
\end{tabularx}
